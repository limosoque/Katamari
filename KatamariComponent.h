...
// ─── GPU constant buffer (matches Katamari.hlsl) ──────────────────────────────
...
struct SceneObject
{
    ...
    // Состояние в мире (пока объект свободен)
    DirectX::XMFLOAT3       position = { 0, 0, 0 };
    DirectX::XMFLOAT3       rotation = { 0, 0, 0 };   // Эйлеровы углы
    float                   scale = 1.0f;
    ...
    // Смещение в локальном пространстве шара (устанавливается в момент поглощения).
